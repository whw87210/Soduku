...
<body style="background-color: yellow; ">
	...
	<p>Player: <scan id='username'>test </scan ></p> 
    <p>Number of Succeed: <scan id='succeed'> 5 </scan> </p>
	<p id="p3"></p>
   ...
   // ppfz MAR-10 代码：
        function getSucceed(){  //应该按 button1 的时候执行吧
           ...
           // 重点是这句： 调用 getSucceed.php
            xmlHttp.open("GET","getSucceed.php?username=test&succeed=25",true);  //这里实际上应该用变量, 我这里就试验性
            xmlHttp.send();
